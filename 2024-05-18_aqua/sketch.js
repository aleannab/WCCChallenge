// Aquamarine by Antoinette Bumatay-Chan
// Created for the #WCCChallenge - Topic: Aqua

// I was inspired by the texture of an aquamarine crystal.
// https://www.irocks.com/minerals/specimen/39044
...
function draw() {
  for (let i = 0; i < 20; i++) {
    ...
    brush.hatch(random(5, 10), HALF_PI, { rand: 0, continuous: false, gradient: false });
  ...
  for (let i = 0; i < 100; i++) {
    ...
    brush.flowLine(width * randomGaussian() * 0.1, random(-0.4) * height, random(0.1, 0.5) * height, -HALF_PI);
  }
}
